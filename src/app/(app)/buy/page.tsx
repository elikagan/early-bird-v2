...
/**
 * Strict-filter view. ?market=X narrows the catalog to "items by
 * dealers who said yes to this market" (booth_settings, declined=false).
 * Favorites + infinite scroll stay client-side.
 */
