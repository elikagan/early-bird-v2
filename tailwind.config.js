  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'eb-title':   ['15px', { lineHeight: '1.3',  fontWeight: '700' }],
        'eb-body':    ['13px', { lineHeight: '1.7',  fontWeight: '400' }],
        'eb-caption':  ['12px', { lineHeight: '1.3',  fontWeight: '400' }],
        'eb-meta':    ['10px', { lineHeight: '1.4',  fontWeight: '400' }],
        'eb-micro':   ['9px',  { lineHeight: '1.2',  fontWeight: '700' }],
      },
    },
  },
  plugins: [],
